const FRlinInfo = [
    ...
    {"num":"275100","g":1435,"len":2,"use":"FD","end":"1990?","lid":"#Embranchements_urbains_de_Douai(Nord)","sa":"Raccordements_de_la_ligne_Paris-Nord_-_Lille#Embranchements_urbains_de_Douai"},
...
const lidOSMroute = [
"Funiculaire de Montmartre","Métro Ligne 2 : Saint-Philibert → CH Dron","Lacanau à l'Océan","Facture à Lesparre","Margaux à Sainte-Hélène","Nice à Meyrargues","Voie de la Dombes","LGV Rhin-Rhône","Auneau-Ville à Dreux","Lourdes à Pierrefite","Ligne RFF de Buzy à Laruns-Eaux-Bonnes-Les Eaux-Chaudes","","","","Waziers - Sin-le-Noble","Besançon à Pontarlier","","Gray à Dole","Voie de dessserte des Roches Carrières","Montagney à Miserey","","Andelot à Salins","Saint-Rambert d'Albon à Rives","Tramway de Besançon à Vesoul","Ligne Entrée dans Bordeaux","LGV Méditerranée (Section Avignon - Nimes)","section Rang Du Fliers Gare à Montreuil Gare","section Montreuil Gare à Renty/Rimeux","Anvin à Calais","Laqueuille à Mont-Dore","Pamiers à Mirepoix Moulin-Neuf","Moulin-Neuf à Lavelanet","Moulin-Neuf à Belbèze","Belbèze à Bram","Belbèze à Limoux","Tramway de Gérardmer","Mortagne-au-Perche à L'Aigle","Mortagne-au-Perche à Sainte-Gauburge","Mamers à Mortagne-au-Perche","Laon à Liart","Montbeliard à Morvillars","Tournemire - Roquefort à Le Vigan","L'Hôpital-du-Grosbois à Lods","Lussac-les-Châteaux à Saint-Saviol","Voujeaucourt à Saint-Hippolyte","Montbozon à Lure","Pontarlier à Gilley","Champagnole à Lons-le-Saunier","Mouchard à Salins-les-Bains","Dijon-Ville à Épinac","Lapeyrouse à Volvic","Bort-les-Orgues à Neussargues","Ruffec à Roumazières-Loubert","Saint-Amand à Hellemmes","Dijon à Châtillon-sur-Seine","","Train des Forts","Funiculaire de Montmartre","Bar-le-Duc à Verdun","Tramway de Munster à la Schlucht","Transcorrézien : Tulle à Ussel (via le viaduc des Rochers Noirs)","Chemin de Fer de la Vallée de Celles","Métro Ligne 2 : CH Dron → Saint-Philibert","Ligne militaire de Saint-Louis au Simserhof","part of former railway Cabanot à Excideuil","Jonzac à Archiac","Chars à Magny-en-Vexin","Voie Verte des Gueules Noires","Montereau à Château-Landon","Perray-Jouannet à Les Fourneaux","Monti'train","Caen à Cerisy-Belle-Étoile","Caen à Dozulé - Putot","Falaise à Berjou","Ancien chemin de fer minier de Caen à Soumont-Saint-Quentin","Mézidon à Trouville-Deauville","Caen à Vire","Sainte-Gauburge à Mesnil-Mauger","Échauffour à Bernay","La Trinité-de-Réville à Lisieux","Petit Anjou : Angers à St Jean de Linières","Petit Anjou : Beaupréau à Saint-Jean-de-Linières","Petit Anjou : Beaupréau à Nantes","Petit-Anjou : Beaupréau à Cholet","Petit Anjou : Baugé à Noyant","Petit Anjou : Angers à Baugé","Petit Anjou : Bécon-les-Granits à Candé","Petit Anjou : Saint-Jean-de-Linières à Bécon-les-Granits","Petit Anjou : Cholet à Saumur","Montluçon à Gouttières","","","Pont-l'Évêque à Honfleur","","Tramways de la Sarthe : Le-Grand-Lucé à Saint-Calais","Tramways de la Sarthe : Le-Mans à Le-Grand-Lucé","Tramways de la Sarthe : Le-Grand-Lucé à La-Chartre-Sur-Le-Loir","Tramways de la Sarthe : Antoigné à Ballon","Tramways de la Sarthe : Le-Mans à Ségrie","Tramways de la Sarthe : Le-Mans à Saint-Denis-D'Orques - Saint-Jean-sur-Erve","Tramways de la Sarthe : Le-Mans à Mayet","Tramways de la Sarthe : Le-Mans à Mamers","Tramways de la Sarthe : La Détourbe à La Ferté Bernard - Montmirail","Tramways de la Sarthe : Changé à Château-du-Loir","Tramways de la Sarthe : Cérans-Foulletourte à La-Flèche","Alençon à Domfront","Domfront à Pontaubault","Tramways de la Sarthe : Fresnay-sur-Sarthe à Alençon","Saint-Hilaire-du-Harcouët à Fougères","Tramways de la Sarthe : Antoigné à Saint-Jean-d'Assé","Chemins de fer départementaux de la Mayenne : Laval à Saint-Jean-sur-Erve","Chemins de fer départementaux de la Mayenne : Landivy à Mayenne","Chemins de fer départementaux de la Mayenne : Laval à Landivy","Tramway d'Erbray : Erbray à La-Chapelle-Glain","Tramway d'Erbray : Erbray à Châteaubriant","Tramway d'Erbray : Erbray à Ancenis","Chemin de la mine","Glos-Montfort à Quetteville","","Evreux-Embranchement à Quetteville","Roumazières-Loubert à Le Vigeant","Argences à gare de Moult","Colombiers à Quarante-Cruzy","Carmaux à Vindrac","Coutances à Sottevast","Valognes Montebourg à Saint-Vaast et à Barfleur","Uzès à Nozières - Brignon","Martinet à Beaucaire, section Remoulins - Le Martinet","Saint-Sernin à Largentière","Vogüé à Lalevade-d'Ardèche","Arles à Lunel","Bordeaux-Benauge à La-Sauvetat-du-Dropt","La Baule-Escoublac à Guérande","Sillé-le-Guillaume à La Hutte - Coulombiers","Vire à Romagny","Hostens à Beautiran","Blaye à Saint-Ciers-sur-Gironde","La Valette à Robiac","Moux à Caunes-Minervois","Carsac à Gourdon","Le Train des aventuriers","Bressuire à Montreuil-Bellay","Parthenay à Melle","Parthenay à Saint-Laurs","Saint-Maixent à Saint-Laurs (achevée jamais mise en service)","Ferrières-d'Aunis à Epannes","Saint-Jean-d'Angély à Saint-Saviol","Archiac à Saint-Ciers-sur-Gironde","Saint-André-de-Cubzac à Puisseguin via Libourne","Transcorrézien : Mortier-Gumont à La-Roche-Canillac","Transcorrézien : Aubazine à Beaulieu via Beynat","Transcorrézien : Turenne à Le Bosplos","Transcorrézien : La-Rivière-de-Mansac à Juillac","Périgueux à Saint-Yrieix-La-Perche","Saint-Yrieix-La-Perche à Thiviers","Périgueux à Saint-Pardoux-la-Rivière","Saint-Pardoux-la-Rivière à Saint-Mathieu","Limoges à Saint-Mathieu et Rochechouart","Limoges à Peyrat-le-Château","Limoges à Saint-Sulpice-les-Feuilles","Les Planchettes à Razès","La-Tuilière à Saint-Junien","Rancon à Bussière-Poitevine","Limoges à Bussière-Poitevine","Sarlat à Villefranche-du-Périgord","Périgueux à Bergerac","Saintes à Jonzac","Mirambeau à Saint-Aigulin","Saint-Fort-sur-Gironde à Port-Maubert","Touvent à Mortagne-sur-Gironde","Saint-Just à Saujon","Saintes à Marennes","Saint-Porchaire à Taillebourg","Barbezieux à Cognac via Archiac","Saint-Jean-d'Angély à Marans","Saint-Jean-d'Angély à Cognac","Saintes à Burie","Angoulême à Matha","Saint-Trojan à Saint-Denis-d'Oléron","Ségonzac à Saint-Angeau","Angoulême à Confolens","Angoulême à Barbézieux","Angoulême à Roumazières","Blanzac à Villebois-Lavalette","Barbézieux à Chalais","Archiac à Barbézieux","Lencloître à Lusignan","Poitiers à Lavausseau","Poitiers à Saint-Martin-l'Ars","Chatellerault à Bouresse","Romorantin à Neung-sur-Beuvron","Blois à Ouzouer-le-Marché- Orléans -Moulin de l'hôpital","","Vias à Lodève","Dorsale wallonne","Athus-Meuse","Ancienne ligne industrielle Sorbier-Peublan - Mines-de-Bert","Jarrie à Bourg-d'Oisans","Montpellier à Rabieux","Gray à Fraisans","Tramway Turckheim à Trois-Epis","","Caen à Courseulles-sur-Mer","Tramway Grenoble — Villard-de-Lans","Boulogne à Bonningues","Urbanloop Nancy","Alençon à Condé-sur-Huisne","La Hutte-Coulombiers à Mamers","Pouzin à Privas","Couliboeuf à Falaise","Montsecret - Vassy à Les Maures","Aubagne à La_Barque","Sentier Nature de la Petite Ceinture du 16e","Albi à Alban","Morteau à Trévillers","Andelot à Levier","Lure à Héricourt","Vesoul à Saint-Georges","Florac à Sainte-Cécile-d'Andorge","Granville à Sourdeval"
];
...
//        .replaceAll("-"," ")             // remove remaining hyphens (optional)
        .replaceAll("saint-","st-")           // Saints et Saintes
...
function getABOSM(str) {
    if(!str.includes(" à ")) return void (noA++) || console.log(`%% no .à. in ${str}`);
    let ends = str.split(" à ");
    let ori = ends[0].trim().split(" ");
    return [ori[ori.length-1].trim(),ends[1].trim()];
}
function namesOK(name, line) {
    const inLineId = (str, lineId, slugId) => {
        let ok = lineId.includes(str);
        if(ok) return true;
        if(str.includes("Saint-Sulpice") && lineId.includes("St-Sulpice"))
            console.log(`Saints... ${slugId} ${slugifyTopo(str)}`);
        return slugId.includes(slugifyTopo(str));
    }
    const fullStrW = line.lid;
    const [ori,trm] = getABOSM(name);
    if(!ori || !fullStrW) return false;
    const slugW = slugifyTopo(fullStrW);
    const oriIsIn = inLineId(ori, fullStrW, slugW); // || inLineId(slugifyTopo(ori), slugW);
    const trmIsIn = inLineId(trm, fullStrW, slugW); // || inLineId(slugifyTopo(trm), slugW);
    if(oriIsIn && trmIsIn) {
        fullOKs.push(`ok with ${ori} - ${trm} -> ${line.num}`);
        return nok++;
    }
    if(oriIsIn || trmIsIn) {
        mid_OKs.push(`mid-ok with ${oriIsIn? ori+"|"+trm:trm+"|"+ori} <-  ${fullStrW}`);
        return npart++;
    }
    return false;
}
...
lidOSMroute.forEach(name =>
  {
    if(!name) {nno++; return;}
    if(!name.includes(" à ")) {noA++; return console.log(`no .à. in ${name}`);}
    const oks = FRlinInfo.filter(l => namesOK(name, l));
    if (oks.length > 5) {
        console.log(`=============> ${oks.length} / ${nok} + ${npart} + ${nunk}`);
    } else nunk++;
  }
);
fullOKs.forEach(str => console.log(str));
mid_OKs.forEach(str => console.log(str));
console.log(`final brkdown(${lidOSMroute.length}) :/: nno=${nno} nok=${nok} npart=${npart} nunk=${nunk} noA=${noA}`);
